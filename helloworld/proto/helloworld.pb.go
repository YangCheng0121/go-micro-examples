...
func (*Pong) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d53fe9c48eadaad, []int{6}
}
...
var fileDescriptor_4d53fe9c48eadaad = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Say) > 0 {
		i -= len(m.Say)
		copy(dAtA[i:], m.Say)
		i = encodeVarintHelloworld(dAtA, i, uint64(len(m.Say)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Msg) > 0 {
		i -= len(m.Msg)
		copy(dAtA[i:], m.Msg)
		i = encodeVarintHelloworld(dAtA, i, uint64(len(m.Msg)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *StreamingRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Count != 0 {
		i = encodeVarintHelloworld(dAtA, i, uint64(m.Count))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Ping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Stroke != 0 {
		i = encodeVarintHelloworld(dAtA, i, uint64(m.Stroke))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *StreamingRequest) Size() (n int) {
	...
	_ = l
	if m.Count != 0 {
		n += 1 + sovHelloworld(uint64(m.Count))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Ping) Size() (n int) {
	...
	_ = l
	if m.Stroke != 0 {
		n += 1 + sovHelloworld(uint64(m.Stroke))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
